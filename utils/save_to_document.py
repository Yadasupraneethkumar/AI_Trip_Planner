...
def save_document(response_text:str, directory: str = "./output"):
    ...
    # Create merkdown content with metadata header
    ...
    *This travel plan was generated by AI. Please verify all information, especially prices, operating hours
    """
    ...
    try:
        ...
        filename = f"{directory}/AI Travel Plan {timestamp}.md"
